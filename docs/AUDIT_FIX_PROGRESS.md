...
| 03. Standard order validation | Database deployed; website release prepared | Migration 20260917162249; 278 tests and production build passed. See AUDIT_FIX_03_CHECKOUT.md for scope and remaining acceptance checks. |
