...
| 02. Public internal costs | F02 / SEC02 | In progress: phase A live; website and phase B pending | Protected admin cost endpoint verified live. Compatible admin queries and final column restrictions prepared; F02 remains open until production enforcement is verified. See AUDIT_FIX_02_PRIVATE_COSTS.md. |
...
The protected admin cost endpoint is live. The compatibility changes and final permission migration are prepared in this release. F02 remains open until the website is deployed and phase B is verified. See [Step 2 evidence and deployment checklist](AUDIT_FIX_02_PRIVATE_COSTS.md).
