...
const groups=[
 {title:'Boxes & protection',copy:'Ready protection boxes and enclosure systems for the AC and DC side of solar installations.',icon:ShieldCheck,items:[
  {name:'ACDB',desc:'AC distribution and protection boxes',q:'ACDB',img:'/acdb-demo.svg'},
  {name:'DCDB',desc:'DC combiner and protection boxes',q:'DCDB',img:'/dcdb-demo.svg'},
  {name:'Enclosures',desc:'IP-rated boxes and cabinets',q:'Enclosure',icon:Boxes},
 ]},
 {title:'Switchgear & surge',copy:'Core protection devices for isolation, overcurrent protection and surge management.',icon:CircuitBoard,items:[
  {name:'MCB / MCCB',desc:'AC and DC circuit protection devices',q:'MCB',img:'/mcb-demo.svg'},
  {name:'SPD',desc:'AC and DC surge protection',q:'SPD',img:'/spd-demo.svg'},
  {name:'DC fuses',desc:'Fuse links, holders and protection',q:'Fuse',img:'/fuse-demo.svg'},
 ]},
 {title:'Wiring & connections',copy:'PV wiring, connectors, terminals and sealed cable-entry components.',icon:Cable,items:[
  {name:'Solar cable',desc:'PV cable and internal wiring',q:'Solar Cable',img:'/cable-demo.svg'},
  {name:'MC4 connectors',desc:'PV connectors and accessories',q:'MC4',img:'/mc4-demo.svg'},
  {name:'Cable glands',desc:'Sealed and secure cable entry',q:'Cable Gland',img:'/gland-demo.svg'},
  {name:'Terminal blocks',desc:'Organised internal connections',q:'Terminal',icon:PlugZap},
 ]},
