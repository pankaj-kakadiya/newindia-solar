...
export default function Checkout(){
  ...
  function useAddress(a:any){touched.current=true;setFields(x=>({...x,name:a.contact_name||'',phone:a.phone||'',address:a.address_line1||'',address2:a.address_line2||'',city:a.city||'',state:a.state||'',pin:a.postal_code||''}))}
