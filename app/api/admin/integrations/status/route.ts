...
const requirements:Record<string,string[]>={
 ...
 payment:['RAZORPAY_KEY_ID','RAZORPAY_KEY_SECRET','RAZORPAY_WEBHOOK_SECRET','SUPABASE_SERVICE_ROLE_KEY'],
 shipping:['SHIPROCKET_EMAIL','SHIPROCKET_PASSWORD','SUPABASE_SERVICE_ROLE_KEY'],
