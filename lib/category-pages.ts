...
export const CATEGORY_PAGES:CategoryPage[]=[
 ...
 {slug:'mcb-mccb',label:'MCB / MCCB',categoryTerms:['mcb','mccb','mcbmccb'],description:'AC and DC circuit breakers for isolation and overcurrent protection.'},
 {slug:'spd',label:'Surge Protection Devices',categoryTerms:['spd','surgeprotection','surgeprotectiondevice','surgeprotectiondevices'],description:'AC and DC surge protection devices for solar installations.'},
