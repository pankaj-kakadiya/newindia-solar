 ...
 return <>
  ...
  <header className="nhHeader" ref={headerRef}>
   <div className="container nhNav">
    ...
    <Link href="/" className="nhBrand" aria-label="New India Solar home"><img width={520} height={160} decoding="async" src={headerLogo} alt={branding.logoAlt}/></Link>
    ...
    <div className="nhActions">
     ...
     <Link href="/bulk-order" className="nhQuoteAction" aria-label="Request project quotation"><FileText size={16}/><span>Project RFQ</span></Link>
