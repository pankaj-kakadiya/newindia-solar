...
const navGroups:NavGroup[]=[
 ...
 {label:'Settings',items:[{href:'/admin/settings',label:'System Settings',icon:Settings,module:'settings'},{href:'/admin/access',label:'Roles & Audit',icon:ShieldCheck,module:'security'},{href:'/admin/change-password',label:'Change Password',icon:KeyRound}]}
]
