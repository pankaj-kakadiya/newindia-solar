...
import {staffRoles,validateManualTeamUser,validateTemporaryPassword} from '../lib/teamUser.ts'
...
test('password-reset validation uses the same strong-password rules',()=>{assert.equal(validateTemporaryPassword('Solar#Team2026'),null);assert.match(validateTemporaryPassword('weakpassword'),/uppercase, lowercase, number and symbol/i)})
